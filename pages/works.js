        ...
        <Container>
            ...
            <SimpleGrid columns={[1, 1, 2]} gap={6}>
                ...
                <Section delay={0.1}>
                    ...
                    >
                        A video work generated with deep learning, imitating
                        famous four painters like Van Gogh
                    </WorkGridItem>
                </Section>
                <Section delay={0.1}>
                    <WorkGridItem
                        ...
                        title="Menkiki"
                    >
                        An app that suggests ramen(noodle) shops based on a
                        given photo of the ramen you want to eat
                    </WorkGridItem>
                </Section>
            </SimpleGrid>
            ...
            <SimpleGrid columns={[1, 1, 2]} gap={6}>
                ...
                <Section delay={0.5}>
                    <WorkGridItem
                        ...
                        title="freeDBTagger"
                    >
                        Automatic audio file tagging tool using FreeDB for
                        Windows
                    </WorkGridItem>
                </Section>
                <Section delay={0.6}>
                    <WorkGridItem
                        ...
                        title="Amembo"
                    >
                        P2P private file sharing tool with MSN Messenger
